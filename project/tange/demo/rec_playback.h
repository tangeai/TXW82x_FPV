 ...
 *
 * 所有 P2P 命令通过 project/tange/demo/demo.c 里的 Handle_P2p_Cmd 分发
...
/* 目标单文件时长 (秒)。报警停止由 3s 后台巡检执行，收尾可能略长。 */
 ...
 */
int pb_stop(void);
/* Stop only the playback owned by the disconnected P2P session. */
