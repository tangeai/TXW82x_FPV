 ...
 * TXW828 双目: 单路原图 720P (1280x720), VPP_DATA0 直抓
 * TXW826:      主码流 720P (1280x720), VPP_DATA0 直抓
 * TXW828 单目: 子码流 640x360, VPP_DATA1 直抓
 */
#define SNAP_JPG_ID        JPGID0        /* 用哪个 JPG 硬件 */

#if defined(SYS_DOUBLE_SENSOR_SPICE_DEMO)
#define SNAP_SRC_FROM      VPP_DATA0     /* 双目抓拍单路原图，不抓纵向拼接 H264 */
#define SNAP_IMG_W         1280
#define SNAP_IMG_H         720
#define SNAP_NODE_COUNT    10
#define SNAP_NODE_LEN      (10 * 1024)   /* 100KB，按 720P 抓拍容量配置 */
