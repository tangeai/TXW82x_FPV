...
//            if(len) {
//				return -1;
//				//TODO: Internal cleaning
//				printf("Going to PM_NETDOWN ...\n");
//				TciSetPowerMode(PM_NETDOWN);
//				printf("set net interface down.\n");
//				
//				static struct os_work work;
//				OS_WORK_INIT(&work, wakeup_me, 0);
//				os_run_work_delay(&work, 6000);
//		
//				return -1; //disable hiberate
//			}
//			else {
//				//TODO: Power off
//			}
...
//            _os_printf("Soft watchdog %s timeouted.\n", (const char*)pData);
//			//TODO: 
//			mcu_reset();
//            break;
...
int IpcStep1(void)
{
    ...
    int psram_test_size = 8;
    TciSetSysOption(TCOPT_MAX_SYS_PSRAM_SIZE, &psram_test_size);
...
#if 0
    char feature[32];
    if(get_device_feature("BatteryCam", feature, sizeof(feature)) >= 0) {
        if(strcmp(feature, "Dormant") == 0) //低功耗设备先分配云存储缓冲区，立即可以准备上传的数据
            TciAllocCloudBuffer(1<<20);
    }
#endif
