...
#define SC2336P_1920X1080_MASTER_2LINE  0
#define SC2336P_1920X1024_SLAVE_1LINE   1

#if SC2336P_1920X1024_SLAVE_1LINE
SENSOR_INIT_SECTION const unsigned char sc2336p_1920x1024_slave_1line_12fps[CMOS_INIT_LEN]= 
{	
    0x01,0x03,0x01,
    0x01,0x00,0x00,
    0x36,0xe9,0x80,
    ...
    0x32,0x31,0x04,
    0x32,0x24,0x83,//0x83下降沿触发,0x82上升沿触发
    0x36,0xe9,0x50,
    0x37,0xf9,0x23,
    0x01,0x00,0x01,
...
#if SC2336P_1920X1080_MASTER_2LINE
SENSOR_INIT_SECTION const unsigned char sc2336p_1920x1080_master_2Line_25fps[CMOS_INIT_LEN]= 
{	
...
const _Sensor_DPC sc2336p_dpc_init = 
{
...
const _Sensor_GAMMA_BV sc2336p_gamma_map = 
{
    .adj_by_bv = 1,
...
const _Sensor_CSC sc2336p_csc_init = 
{
...
const _Sensor_GIC sc2336p_gic_init = 
{
    .w_thres  = 14,
    .w_slope  = 16,
    .w_str    = 127,
...
const _Sensor_COLENH_BV sc2336p_ce_map[BV2COLENH_ARRAY_NUM] = {
...
const _Sensor_LHS sc2336p_lhs_map[9] = {
...
// 预设的Gamma曲线和对应的BV值
const _Sensor_YGAMMA sc2336p_ygamma_tbl[NUM_CURVES] = {
    {
     .bv = 200,
     .packed_lut = {
...
const _Sensor_WDR sc2336p_wdr_init = {
...
const _Sensor_ISP_Init sc2336p_isp_init = 
{
    ...
    .pixel_h      = 1024,
    .pixel_w      = 1920,
#elif SC2336P_1920X1080_MASTER_2LINE
    .pixel_h      = 1080,
    .pixel_w      = 1920,
#endif
    .mirror       = 1,
...
SENSOR_OP_SECTION const _Sensor_Adpt_ sc2336p_cmd= 
{
	...
	.pixelw = 1920,
	.pixelh = 1024,
	.init = (unsigned char*)sc2336p_1920x1024_slave_1line_12fps,
    .mipi_lane_num = 1,
#elif SC2336P_1920X1080_MASTER_2LINE
   	.pixelw = 1920,
	.pixelh = 1080,
	.init = (unsigned char*)sc2336p_1920x1080_master_2Line_25fps,
    .mipi_lane_num = 2, 
#endif
