...
#define ISP_VER     "SDK_42229_20260608_V5"
...
const _Sensor_COLENH_BV sc1346_ce_map[BV2COLENH_ARRAY_NUM] = {
    ...
    {.bv =     400, .hue = 0, .luma = 50, .contrast = 50, .saturation = 60},
    {.bv =     222, .hue = 0, .luma = 50, .contrast = 60, .saturation = 60},
    {.bv =     115, .hue = 0, .luma = 50, .contrast = 60, .saturation = 60},
    {.bv =      57, .hue = 0, .luma = 50, .contrast = 50, .saturation = 60},
    {.bv =      34, .hue = 0, .luma = 50, .contrast = 50, .saturation = 60},
};
...
const _Sensor_BV2NR sc1346_bv2nr_init[BV2RAWNR_ARRAY_NUM] = {
    ...
    {        10000,                     8 ,          511,                      63,         1,          1,              1,             1},    // 646lux
    {         5993,                     8 ,          400,                      63,         1,          1,              1,             1},    // 240lux
    {         3022,                     16,           250,                      63,         1,         1,              1,             1},    // 20lux
...
const _Sensor_YGAMMA sc1346_ygamma_tbl[NUM_CURVES] = {
    {
     .bv = 200,
     .packed_lut = {
        // 0x01602c00, 0x02c08416, 0x0420dc2c, 0x05713442, 0x06d18857, 0x0821e06d, 0x09723482, 0x0ac28897, 
        // 0x0c12dcac, 0x0d532cc1, 0x0e937cd5, 0x0fd3cce9, 0x110418fd, 0x12346910, 0x1364b523, 0x14a50136, 
        // 0x15d54d4a, 0x1705995d, 0x1835e570, 0x19663183, 0x1a967d96, 0x1bb6c9a9, 0x1ce715bb, 0x1e075dce, 
        // 0x1f37a5e0, 0x2057f1f3, 0x21783a05, 0x22988217, 0x23b8ca29, 0x24d9123b, 0x25f95a4d, 0x2709a25f, 
        // 0x2829e670, 0x293a2a82, 0x2a3a6e93, 0x2b4ab2a3, 0x2c4af2b4, 0x2d4b32c4, 0x2e4b72d4, 0x2f4bb2e4, 
        // 0x303beef4, 0x312c2b03, 0x321c6712, 0x32fca321, 0x33dcdb2f, 0x34bd133d, 0x358d4b4b, 0x365d7f58, 
        // 0x372db365, 0x37dde372, 0x388e0f7d, 0x393e3b88, 0x39de6393, 0x3a7e8b9d, 0x3b0eb3a7, 0x3baed7b0, 
        // 0x3c3efbba, 0x3ccf1fc3, 0x3d5f43cc, 0x3ddf67d5, 0x3e6f8bdd, 0x3effabe6, 0x3f7fcfef, 0x3fffeff7,

        0x01a03400, 0x03509c1a, 0x04f10835, 0x0691704f, 0x0831d869, 0x09d24083, 0x0b62a89d, 0x0d030cb6, 
        0x0ea374d0, 0x1033d8ea, 0x11c43d03, 0x1344a11c, 0x14d50534, 0x1665654d, 0x17e5c966, 0x1966297e, 
        0x1ae68996, 0x1c56e9ae, 0x1db741c5, 0x1f1799db, 0x2077f1f1, 0x21c84607, 0x23089a1c, 0x2448ea30, 
        0x25793a44, 0x26998257, 0x2799c669, 0x289a0679, 0x298a4689, 0x2a7a7e98, 0x2b4ab6a7, 0x2c1aeeb4, 
        0x2ceb22c1, 0x2dab52ce, 0x2e6b82da, 0x2f1bb2e6, 0x2fcbdaf1, 0x306c06fc, 0x310c2f06, 0x319c5710, 
        0x322c7b19, 0x32bc9f22, 0x334cc32b, 0x33dce734, 0x346d0b3d, 0x34fd2f46, 0x358d534f, 0x361d7758, 
        0x369d9761, 0x371db769, 0x37addb71, 0x382dfb7a, 0x38be1b82, 0x393e3f8b, 0x39de6393, 0x3a6e879d, 
        0x3b0eafa6, 0x3bbedbb0, 0x3c6f03bb, 0x3d1f2fc6, 0x3dcf5fd1, 0x3e8f8bdc, 0x3f4fbbe8, 0x3fffebf4, 
    }},
    {
     .bv = 500,
    ...
    {// ?????BV=500
     ...
     .packed_lut = {
        ...
        // 0x11042100, 0x12046110, 0x1304a120, 0x1404e130, 0x15052140, 0x16056150, 0x16f59d60, 0x17f5dd6f, 
        // 0x18f61d7f, 0x19f65d8f, 0x1af69d9f, 0x1bf6ddaf, 0x1cf71dbf, 0x1df75dcf, 0x1ef79ddf, 0x1fe7ddef, 
        // 0x20e819fe, 0x21e85a0e, 0x22e89a1e, 0x23e8da2e, 0x24e91a3e, 0x25e95a4e, 0x26e99a5e, 0x27e9da6e, 
        // 0x28ea1a7e, 0x29ea5a8e, 0x2aea9a9e, 0x2bdad6ae, 0x2cdb16bd, 0x2ddb56cd, 0x2edb96dd, 0x2fdbd6ed, 
        // 0x30dc16fd, 0x31dc570d, 0x32dc971d, 0x33ecd72d, 0x34ed1b3e, 0x35ed5b4e, 0x36ed9b5e, 0x37eddb6e, 
        // 0x38ee1b7e, 0x39fe5b8e, 0x3afe9f9f, 0x3bfedfaf, 0x3cff1fbf, 0x3e0f5fcf, 0x3f0fa3e0, 0x3fffe3f0,

        0x01202400, 0x02306812, 0x0350b023, 0x0460f435, 0x05813c46, 0x06918058, 0x07b1c869, 0x08c20c7b, 
        0x09e2548c, 0x0af2989e, 0x0c12e0af, 0x0d2324c1, 0x0e336cd2, 0x0f53b0e3, 0x1063f4f5, 0x11743d06, 
        0x12948117, 0x13a4c529, 0x14b5093a, 0x15c5514b, 0x16d5955c, 0x17f5d96d, 0x19061d7f, 0x1a166190, 
        0x1b26a5a1, 0x1c36e9b2, 0x1d472dc3, 0x1e5771d4, 0x1f57b5e5, 0x2067f9f5, 0x21683a06, 0x22687a16, 
        0x2368ba26, 0x2458fa36, 0x25593645, 0x26497655, 0x2739b264, 0x2829ee73, 0x291a2a82, 0x2a0a6291, 
        0x2aea9ea0, 0x2bdadaae, 0x2cbb12bd, 0x2dab4ecb, 0x2e8b86da, 0x2f7bc2e8, 0x305bfaf7, 0x314c3705, 
        0x322c6f14, 0x331cab22, 0x340ce731, 0x34fd1f40, 0x35dd5b4f, 0x36cd975d, 0x37bdd36c, 0x38ae0b7b, 
        0x399e478a, 0x3a7e8399, 0x3b6ebfa7, 0x3c5ef7b6, 0x3d4f33c5, 0x3e2f6fd4, 0x3f1fabe2, 0x3fffe7f1,
...
void SC1346_ae_adjust(struct isp_exposure_opt *p_cfg)
{
    /* 只在第一次初始化时打印一次 ISP 版本信息 */
    static uint8_t isp_ver_printed = 0;
    if (isp_ver_printed == 0) {
        os_printf("ISP_VER: %s\n", ISP_VER);
        isp_ver_printed = 1;
    }
    ...
    // os_printf("======> exposure_line :%s %x  %x %x %x \n",ISP_VER,exposure_line,((exposure_line << 4) & 0xf0),((exposure_line >> 4) & 0xff),((exposure_line >> 12) & 0x0f));
    //os_printf("======> exposure_line :%s total_gain_int:%d  dig_gain:%d fine_val:%d %x \n",ISP_VER,total_gain_int,dig_gain,fine_val,gain_value[ana_idx]);
