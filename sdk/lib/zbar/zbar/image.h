...
struct zbar_image_s {
    ...
    /* caller-provided scratch buffers for QR decoding (bare-metal friendly).
     * If NULL (or too small), the QR decoder allocates internally.
     *   qr_mask_buf / qr_mask_size: w*h bytes for the binarized mask
     *   qr_sums_buf / qr_sums_size: w unsigned ints of scratch
     */
